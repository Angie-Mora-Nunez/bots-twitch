...
client.on('message', (channel, tags, message, self) => {
	if (message.toLowerCase() === '!magicball'|| message.toLocaleLowerCase()=== "!magicball"+message) {
...
function onCheerHandler(channel, userstate, message)  {
  client.say(channel,
    `Clap clap @${userstate.username} muchas gracias enormemente agradecidos por esa cantidad increíble de ${userstate.bits} bits!`
  )
}
