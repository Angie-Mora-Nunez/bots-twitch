...
client.on('message', (CHANNEL_NAME, username,client) => {
  var a="";
	if (message.toLowerCase() === '!magicball'+a) {
		client.say(CHANNEL_NAME,"Estoy analizando mi bola mágica y mi respuesta es "+ jokes[Math.floor(Math.random() * jokes.length)]);
	}
});
