...
Hola guapeton, las reglas de este chat son simples. -No insultes.. o hay timeout. -No hagas spam... o hay timeout. -No molestes a usuarios... o hay timeout. -No mandes links.... o hay timeout.. -NO PIDAS VIP NI MOD.. o por insistencia te damos Timeout... Si después de leer esto, lo incumples un /ban se te vería bien :3...besitos :kissing_heart:
client.on('message', (channel, tags, message, self) => {
