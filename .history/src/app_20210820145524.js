...
client.on('message', (channel, tags, message, self) => {
	...
	if (message.toLowerCase() === '!Redes') {
		client.say(channel,"Whatsapp: https://chat.whatsapp.com/LYc91TjrMjtIfprp766PYl"+"\n Instagram: https://www.instagram.com/b4mpixd/"+"\n Discord https://discord.gg/K25j7CznSZ "+"\n Tiktok https://www.tiktok.com/@b4mpi_"+ "\n outube https://www.youtube.com/channel/UC29LyjZgFNmgPDzNehgaQ5A");
	}
});

Lista de Comandos ☞!redes ☞!tula ☞!pregunta (pregunta para el bot) ☞!love (Descubre el amor) ☞!dorito (regala un dorito) ☞!duelo (Duelo con otro user del chat) ☞!ruleta(prueba tu suerte) ☞!uptime (Tiempo de directo) ☞!tiempo (¿Cuanto llevas de seguir a Bampi?) ☞!bh Conoce el mejor canal de ESports ☞!sr pide una canción ☞!fiesta ☞!años !beso !cachetada !patada !hermo !dat
