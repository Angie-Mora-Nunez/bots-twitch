...
client.on('message', (channel, tags, message, self) => {
	...
	if (message.toLowerCase() === '!comandos') {
		client.say(channel,"Lista de Comandos ☞!redes ☞!tula ☞!love (Descubre el amor) ☞!dorito (regala un dorito) ☞!duelo ☞!uptime ☞!tiempo ☞!bh Conoce el mejor canal de ESports ☞!sr pide una canción ☞!fiesta ☞!años, ☞!beso, ☞!cachetada, ☞!patada, ☞!hermo, ☞!dat, ☞!magicball");
	}
});
