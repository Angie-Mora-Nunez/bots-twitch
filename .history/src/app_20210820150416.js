...
function onRaidedHandler(channel, username, viewers) {
  client.say(channel,
    `Hey Clap clap @${username} muchas gracias por ese raid con ${viewers} guapetes!. Ve a dar una vuelta por su canal y dale un corazoncito. https://www.twitch.tv/b4mpi`
  )
}
