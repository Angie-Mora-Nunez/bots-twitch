...
client.on('message', (channel, tags, message, self) => {
	...
	if (message.toLowerCase() === '!dat') {
		client.say(channel,"A @B4mpi le dicen así porqué de pequeño, cuando estaba en la escuela se le cayeron todos los dientes, excepto los colmillos, desde ahí su familia lo llamo vampiro");
	}
});
