...
client.on('message', (channel, tags, message, self) => {
	...
	if(message.toLowerCase() === 'hola'|| message.toLowerCase()=== 'buenas'|| message.toLowerCase()=== 'holaaa'|| message.toLowerCase().startsWith( 'buenas') || message.toLowerCase().startsWith'buenas' ) {
