...
client.on ("chat", function (channel, user, message, self) {
    ...
    client.on ("chat", function (channel, user, message, self) {
      ...
      client.say(channel, "las reglas de este chat son simples. -No insultes.. o hay timeout. -No hagas spam... o hay timeout. -No molestes a usuarios... o hay timeout. -No mandes links.... o hay timeout..  Si después de leer esto, lo incumples un /ban se te vería bien :3...besitos :kissing_heart:Por mandar spam, molestar a usuarios, pedir VIP o MOD se te dará un timeout de 1 minuto para que reflexiones. Si incumples 3 veces, serás baneado. Si la ofensa es de peso, hacia Bampi u otro usuario, tendrás un timeout de 5 minutos, si lo vuelves a hacer, serás baneado. Muchas gracias 
GlitchCat");
      };
      };
      });
