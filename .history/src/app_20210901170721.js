...
client.on ("chat", function (channel, user, message, self) {
  ...
  if (message.toLowerCase() === '!host') {
    client.say(channel,"Recuerda que con host ayudas a que lleguemos a recomendadosMe ayuda mucho si me ayudas con un host. Desde el celular ve al botón de compartir y abajo dale hostear. Desde la compu ve a tu canal e ingresa /host B4mpi. Gracias guapetón 
:)
